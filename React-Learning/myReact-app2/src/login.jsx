...
function Login(){
    ...
    return(
        ...
        <form className="my-5" style={{color:"whitesmoke",width:"50%", margin:"auto"}}>
            ...
            <input type="password" value={pwd} onChange={handlePwdChange} className="form-control" id="InputPassword" required/>
            </div>

            <div className="mb-3">
            <label htmlFor="ConfirmInputPassword" className="form-label">Confirm Password</label>
            <input type="password" value={cpwd} onChange={(Event)=>handleCPwdChange(Event)} className="form-control" id="ConfirmInputPassword" required/>
            </div>
